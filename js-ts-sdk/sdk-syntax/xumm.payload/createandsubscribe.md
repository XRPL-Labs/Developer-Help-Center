...
All information that applies on `Sdk.payload.create()` and `Sdk.payload.subscribe()` applies. [create.md](create.md "mention") / [subscribe.md](subscribe.md "mention"). For the contents of a Payload, see the [**API Docs for more information about payloads object contents**](https://xumm.readme.io/reference/post-payload).\
\
Differences are:
